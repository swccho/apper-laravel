...
@section('content')
    <div class="page home">
        {{--hero section start--}}
        <section class="hero" id="hero" style="background-image: url('{{asset('/images/hero-image.png')}}')">
            <div class="container">
                <div class="content">
                    <div class="inner">
                        <div class="left">
                            ...
                            <div class="store">
                                <a class="apple">
                                    <img src="{{asset('/images/appstore_blue.png')}}" alt=""/>
                                    <img src="{{asset('/images/appstore_white.png')}}" alt=""/>
                                </a>
                                <a class="google">
                                    <img src="{{asset('/images/googleplay_blue.png')}}" alt=""/>
                                    <img src="{{asset('/images/googleplay_white.png')}}" alt=""/>
                                </a>
                            </div>
                            <div class="users">
                                <ul class="images">
                                    <li>
                                        <img src="{{asset('/images/used01.png')}}" alt=""/>
                                    </li>
                                    <li>
                                        <img src="{{asset('/images/used02.png')}}" alt=""/>
                                    </li>
                                    <li>
                                        <img src="{{asset('/images/used03.png')}}" alt=""/>
                                    </li>
                                    <li>
                                        <img src="{{asset('/images/used04.png')}}" alt=""/>
                                    </li>
                                </ul>
                                <div class="text">
                                    <div>12M+</div>
                        ...
                        <div class="right">
                            <button class="btn play-btn">
                                <img src="{{asset('/images/play_icon.png')}}" alt="play-icon"/>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="body">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="frame">
                                <img src="{{asset('/images/features_frame.png')}}" alt=""/>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="right">
                                <div>
                                    <div class="item three" data-aos="fade-left">
                                        <div class="icon">
                                    ...
                                    <div class="item four" data-aos="fade-left">
                                        <div class="icon">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="box" data-aos="fade-zoom-in">
                            <div class="frame">
                                <img src="{{asset('/images/about-frame.png')}}" alt=""/>
                            </div>
                            <div class="screen">
                                <img src="{{asset('/images/about-screen.png')}}" alt=""/>
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="content">
                            ...
                            <div class="body">
                                ...
                                <button class="btn btn-theme">start free trial</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {{--modern ui section start--}}
        <section class="modern-ui">
            <div class="container">
                <div class="row">
                    <div class="col-6">
                        <div class="header" data-aos="fade-up">
                        ...
                        <div class="body">
                            <div class="list-item" data-aos="fade-up">
                                <div class="icon">
                                    <img src="{{asset('/images/right_icon.png')}}" alt=""/>
                                </div>
                                <div class="text">
                                    <div class="title">Carefully designed</div>
                                    <div class="desc">Lorem Ipsum is simply dummy text of the printing and type
                            ...
                            <div class="list-item" data-aos="fade-up">
                                ...
                                <div class="text">
                                    <div class="title">Seamless Sync</div>
                                    <div class="desc">Simply dummy text of the printing and typesetting inustry
                            ...
                            <div class="list-item" data-aos="fade-up">
                                ...
                                <div class="text">
                                    <div class="title">Access Drive</div>
                                    <div class="desc">Printing and typesetting industry lorem Ipsum has been the
                    ...
                    <div class="col-6">
                        <div class="box"
                             ...
                             data-aos-offset="0">
                            <div class="left">
                                <img src="{{asset('/images/modern01.png')}}" alt=""/>
                            </div>
                            <div class="right">
                                <div class="img-1">
                                    <img src="{{asset('/images/secure_data.png')}}" alt=""/>
                                ...
                                <div class="img-2">
                                    <img src="{{asset('/images/modern02.png')}}" alt=""/>
                                </div>
                                <div class="img-3">
                                    <img src="{{asset('/images/modern03.png')}}" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="work">
            <div class="container">
                <div class="content">
                    <div class="header" data-aos="fade-up">
                        <div class="title">How it works - 3 easy steps</div>
                        <div class="desc">
                            Lorem Ipsum is simply dummy text of the printing and typese tting
                            <br/> indus orem Ipsum has beenthe standard dummy.
                        </div>
                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-4">
                                <div class="step">
                                    <div class="icon one" data-aos="fade-left">
                                    ...
                                    <div data-aos="fade-right">
                                        ...
                                        <div class="desc">Download App either for Windows, Mac or Android </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="step">
                                    <div class="icon two" data-aos="fade-left">
                                        <img src="{{asset('/images/functional.png')}}" alt=""/>
                                    </div>
                                    <div data-aos="fade-right">
                                        <div class="title">Create account</div>
                                        <div class="slug">14 days free trial</div>
                                        <div class="desc">Download App either for Windows, Mac or Android </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="step">
                                    <div class="icon three" data-aos="fade-left">
                                        <img src="{{asset('/images/live-chat.png')}}" alt=""/>
                                    </div>
                                    <div data-aos="fade-right">
                                        <div class="title">It’s done, enjoy the app</div>
                                        <div class="slug">Have any questions check our FAQs</div>
                                        <div class="desc">Download App either for Windows, Mac or Android </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="testimonial">
            <div class="container">
                <div class="header" data-aos="fade-up">
                    ...
                    <div class="body">
                        <div class="reviews" style="background-image: url('{{asset('/images/avtar_testimonial.png')}}')"
                            data-aos="fade-zoom-in"
                             data-aos-easing="ease-in-back"
                             data-aos-delay="300"
                             data-aos-offset="0">
                                            ...
                                            <div class="swiper-slide">
                                               ...
                                               <span>
                                                   ...
                                                   <i class="las la-star"></i>
                                                    ...
                                                    <div class="avatar">
                                                        <img src="{{asset('/images/testimonial_user1.png')}}" alt=""/>
                                                    </div>
                                                    <div class="name">Shanaya John</div>
                                                    <div class="company">Careative inc</div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="review-item">
                                                    ...
                                                    <div class="avatar">
                                                        <img src="{{asset('/images/testimonial_user2.png')}}" alt=""/>
                                                    </div>
                                                    <div class="name">Willium Den</div>
                                                    <div class="company">Careative inc</div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="review-item">
                                                    ...
                                                    <div class="avatar">
                                                        <img src="{{asset('/images/testimonial_user3.png')}}" alt=""/>
                                                    </div>
                        ...
                        <div class="total-review">
                            <div class="rating">
                               <span>
                                ...
                                <span class="number">5.0 / 5.0</span>
                            </div>
                            <div class="count">2578</div>
                            <a href="">total user reviews <i class="las la-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="plan">
            <div class="container">
                ...
                <div class="body" data-aos="fade-up">
                    <div class="row">
                        <div class="col-4">
                            <div class="item">
                                <div class="top">
                                    <div class="icon">
                                        <img src="{{asset('/images/standard.png')}}" alt=""/>
                                    </div>
                                    <div class="title">Standard</div>
                                    <div class="slug">For the basics</div>
                                </div>
                                ...
                                <div class="btn btn-theme">Buy now</div>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="item unlimited">
                                <div class="top">
                                    <div class="icon">
                                        <img src="{{asset('/images/unlimited.png')}}" alt=""/>
                                    </div>
                                    <div class="title">Unlimited</div>
                                    <div class="slug">For the professionals</div>
                                </div>
                        ...
                        <div class="col-4">
                            <div class="item">
                                <div class="top">
                                    ...
                                    <div class="slug">For small team</div>
                                </div>
                    ...
                    <div class="chose-custom" data-aos="fade-up">
            ...
            <div class="body">
                <div class="screens">
                    <div class="swiper interfaceSwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src={{asset('/images/screen-3.png')}} alt=""/>
                            </div>
                            <div class="swiper-slide">
                                <img src={{asset('/images/screen-3.png')}} alt=""/>
                            </div>
        ...
        {{--free app section start--}}
        <section class="shared free-app">
            <div class="container">
                <div class="body"
                     data-aos="fade-zoom-in"
                     data-aos-easing="ease-in-back"
                    ...
                    <div class="content">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="right">
                                    <div class="img">
                                        <img src="{{asset('/images/download-screen01.png')}}" alt=""/>
                                    </div>
                                    <div class="img">
                                        <img src="{{asset('/images/download-screen02.png')}}" alt=""/>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        {{--free app section end--}}

        {{--blog section start--}}
        <section class="shared blog">
            <div class="container">
                <div class="header" data-aos="fade-up">
                    <div class="title">
                ...
                <div class="body">
                    <div class="row" data-aos="fade-up">
                        <div class="col-4">
                            <div class="item">
                                <div class="thumbnail">
                                    <img src="{{asset('/images/story01.png')}}" alt=""/>
                                    <div class="publish-time">45 min ago</div>
                                </div>
                                <div class="content">
                                    <div class="title">Cool features added!</div>
                                    <div class="desc">
                        ...
                        <div class="col-4">
                            <div class="item">
                                <div class="thumbnail">
                                    <img src="{{asset('/images/story02.png')}}" alt=""/>
                                    <div class="publish-time">45 min ago</div>
                                </div>
                                <div class="content">
                                    <div class="title">Top rated app! Yupp.</div>
                                    <div class="desc">
                        ...
                        <div class="col-4">
                            <div class="item">
                                <div class="thumbnail">
                                    <img src="{{asset('/images/story03.png')}}" alt=""/>
                                    <div class="publish-time">45 min ago</div>
                                </div>
                                <div class="content">
                                    <div class="title">Creative ideas on app.</div>
                                    <div class="desc">
