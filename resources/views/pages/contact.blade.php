...
@section('content')
    ...
    <div class="shared bread-crumb" style="background-image: url('{{asset('/images/bread_crumb_bg.png')}}')">
        <div>
            ...
            <div class="desc mb-3">If you have an query, please get in touch with us, we will revert back quickly.</div>
            <ul class="menu">
                <li>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="contact-form">
                            <div class="header">
                                ...
                                <div class="desc">Fill up form below, our team will get back soon</div>
                            </div>
                            <div class="body">
                                <form>
                    ...
                    <div class="col-6">
                        <div class="right">
                            <div class="top">
                                <div class="icon">
                                    <img src="{{asset('/images/contact_message_icon.png')}}" alt=""/>
                                </div>
                                <div class="header">
                                    <div class="title">
                                ...
                                <button class="btn btn-theme">read faq</button>
                            </div>
                            <div class="bottom">
                                <div class="details">
                                    <div class="icon">
                                        <img src="{{asset('/images/mail_icon.png.png')}}" alt=""/>
                                    </div>
                                    <div class="info">
                                ...
                                <div class="details">
                                    <div class="icon">
                                        <img src="{{asset('/images/call_icon.png')}}" alt=""/>
                                    </div>
                                    <div class="info">
                                        <div class="label">Call Us</div>
                                        <div class="text">+1 (888) 553-46-11</div>
                                    </div>
                                </div>
                                <div class="details">
                                    <div class="icon">
                                        <img src="{{asset('/images/location_icon.png')}}" alt=""/>
                                    </div>
                                    <div class="info">
                                        <div class="label">Visit Us</div>
                                        <div class="text">5687, Business Avenue, New York, USA 5687</div>
                                    </div>
                                </div>
                            </div>
                        </div>
