           ...
           <div class="container">
               <div class="blog-content">
                   <div class="blog-top">
                       ...
                       <div class="thumbnail">
                           <img src="{{asset('/images/blog_detail_main.png')}}" alt=""/>
                       </div>
                       <div class="desc">
                   ...
                   <div class="we-best">
                       <div class="top">
                           ...
                           <ul class="list">
                               <li>
                                   <span><i class="lar la-check-circle"></i></span>
                           ...
                           <div class="blog-images">
                               <div class="row">
                                   <div class="col-6">
                                       <div class="img">
                                           <img src="{{asset('/images/blog_sub_01.png')}}" alt=""/>
                                       </div>
                                   </div>
                                   <div class="col-6">
                                       <div class="img">
                                           <img src="{{asset('/images/blog_sub_02.png')}}" alt=""/>
                                       </div>
                                   </div>
                               </div>
                           </div>
                       ...
                       <div class="bottom">
                           ...
                           <div class="quote">
                               <div class="icon">
                                   <img src="{{asset('/images/quote_icon.png')}}" alt=""/>
                               </div>
                               <div class="text">
                                   Lorem Ipsum is simply dummy text of the printing and typesetting in dustry lorem
                   ...
                   <div class="writer">
                       <div class="info">
                           <div class="img">
                               <img src="{{asset('/images/blog_d02.png')}}" alt=""/>
                           </div>
                           <div>
                               <div class="name">By: John Dow</div>
                   ...
                   <div class="comment">
                       <div class="info">
                           ...
                           <div>
                               ...
                               <div class="name">Dolly Shell</div>
                           </div>
                       </div>
                       <div class="text">
                           Lorem Ipsum is simply dummy text of the printing and typesetting in dustry lorem Ipsum
                   ...
                   <div class="comment">
                       <div class="info">
                           ...
                           <div>
                               ...
                               <div class="name">Sherly Shie</div>
                           </div>
                       </div>
                       <div class="text">
                           Lorem Ipsum is simply dummy text of the printing and typesetting in dustry lorem Ipsum
                           ...
                           <form>
                               <div class="row">
                                   ...
                                   <div class="col-12 text-center">
                                       <button class="btn btn-theme">Post comments</button>
                                   </div>
                               </div>
                           </form>
                       </div>
